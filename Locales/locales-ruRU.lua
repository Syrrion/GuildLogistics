...
L["tab_consumables"]      = "Расходуемые (Зелья и Фиалы)"
...
L["simc_intro"] = "Эта вкладка показывает рейтинги аксессуаров, полученные симуляциями, по классу/специализации и числу целей. Используйте фильтры, чтобы менять класс, спек, количество целей и уровень предмета. Источник: bloodmallet.com"
