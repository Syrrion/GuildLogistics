...
L["tab_consumables"]      = "BiS DPS : Расходуемые"
...
-- ===           BiS TAB (Trinkets)           === --
-- ============================================== --
L["tab_bis"]         = "BiS : Аксессуары (wowhead)"
L["col_tier"]        = "Уровень"
...
L["simc_intro"] = "Эта вкладка показывает рейтинги аксессуаров, полученные симуляциями, по классу/специализации и числу целей. Используйте фильтры, чтобы менять класс, спек, количество целей и уровень предмета."
...
-- Helpers Trinkets
L["tab_trinkets"]        = "BiS DPS : Тринкеты"

-- Missing labels for consumables lists
L["lbl_phials"]           = "Фиалы"
L["lbl_potions"]          = "Зелья"
L["consum_intro"]         = "Эта вкладка показывает результаты DPS‑симуляций для боевых фиалов (слева) и зелий (справа) по классу и специализации. Выберите класс/спек в выпадающих списках."
L["lbl_targets"]         = "Цели"
L["lbl_target_single"]   = "1 цель"
L["lbl_target_plural"]   = "%d целей"
L["lbl_ilvl"]            = "Уровень предмета"
L["lbl_ilvl_value"]      = "ilvl %d"
L["lbl_trinket"]         = "Тринкет"
L["lbl_score"]           = "Очки"
L["lbl_diff"]            = "Разница"
L["lbl_source"]          = "Источник"
L["label_legendary"]     = "Легендарный"
L["footer_source_bloodmallet"] = "Источник: https://bloodmallet.com/"

-- Всплывающее окно ранжирования лута
L["loot_rank_title"] = "Ранжирование выпавшего предмета"
L["col_score"] = "Очки"
