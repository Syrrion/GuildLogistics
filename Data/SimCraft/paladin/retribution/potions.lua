...
ns.Consum_paladin_retribution_potions = [[
{
    "class_id": 2,
    "data": {
    ...
    "profile": {
        "character": {
            ...
            "role": "attack",
            "spec": "retribution",
            "talents": "CYEAAAAAAAAAAAAAAAAAAAAAAAAAAYAAamltZmtltxYbMz22MbAAAAAAY00MMMzYbGMbDzysNDDDmhhlF2AAAIzMtNLz2MAgNgBAjxMMDA"
        },
        "items": {
            "back": {
                "bonus_id": "12399/9893",
