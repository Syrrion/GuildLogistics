...
L["group_tracker_toggle"]      = "Show floating window"
L["group_tracker_hint"]        = "Tip: you can list explicit IDs in Data/Potions.lua (CONS/CATEGORY); otherwise a name/icon heuristic is used."
