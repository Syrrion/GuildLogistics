...
L["group_tracker_toggle"]     = "Afficher la fenêtre flottante"
L["group_tracker_hint"]       = "Astuce : les catégories peuvent être précisées via Data/Potions.lua (CONS/CATEGORY) ; sinon heuristique nom/icône."
